...
const jsonLd = {
  ...
  sameAs: [
    'https://www.nmlsconsumeraccess.org/EntityDetails.aspx/INDIVIDUAL/794730',
    'https://www.linkedin.com/in/jamie-becker-mortgage',
    'https://www.thebeckerteam.com',
  ],
  knowsAbout: [
    'VA Loans',
    'FHA Loans',
  ...
  areaServed: ['Colorado', 'Georgia', 'Oregon'],
  description:
