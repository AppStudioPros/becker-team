  ...
  return (
    <div>
      ...
      {value ? (
        ...
        <div
          className="border-2 border-dashed rounded-lg p-6 text-center cursor-pointer transition-colors hover:bg-amber-50/30"
          style={{ borderColor: uploading ? '#1c3023' : '#ede4cc' }}
        ...
        >
          ...
          <div className="flex flex-col items-center gap-2">
            {uploading ? (
              <>
                <div className="w-8 h-8 border-2 border-t-transparent rounded-full animate-spin" style={{ borderColor: '#1c3023', borderTopColor: 'transparent' }} />
                <p className="text-sm font-medium" style={{ color: '#1c3023' }}>Uploading...</p>
              </>
            ) : (
              <>
                <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{ backgroundColor: '#f5ecd8' }}>
                  <Upload size={17} style={{ color: '#1c3023' }} />
                </div>
                <p className="text-sm font-medium" style={{ color: '#1c3023' }}>Click to upload</p>
                <p className="text-xs" style={{ color: '#aaa' }}>or drag and drop — PNG, JPG, WEBP</p>
              </>
            )}
          </div>
        </div>
